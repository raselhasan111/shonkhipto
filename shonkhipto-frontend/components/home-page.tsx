...
import { googleAuthenticate, handleLogout } from "@/lib/actions";
...
export function HomePage() {
  ...
  const [errorMsgSignOut, dispatchSignOut] = useFormState(
    handleLogout,
    undefined
  ); //logout hook
  ...
  const [shortUrls, setShortUrls] = useState([
    {
      id: 1,
      original: "https://www.example.com/very/long/url/1",
      short: "https://tinylink.com/abc123",
      clicks: 15,
    },
    {
      id: 2,
      original: "https://www.example.com/another/long/url/2",
      short: "https://tinylink.com/def456",
      clicks: 8,
    },
  ]);
  ...
  const handleCreateShortUrl = (e: React.FormEvent) => {
    ...
    if (longUrl) {
      const newShortUrl = {
        ...
        original: longUrl,
        short: `https://tinylink.com/${Math.random()
          .toString(36)
          .substr(2, 6)}`,
        clicks: 0,
      };
    ...
    <div className="min-h-screen w-full max-w-4xl mx-auto px-6 bg-white shadow-md flex flex-col">
      <header className="w-full mx-auto p-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">
          সংক্ষিপ্ত <span className="text-xs font-normal">url-shortener</span>
        </h1>
        {isLoggedIn ? (
              ...
              {isLoggedIn ? (
                ...
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      Please log in with your Google account to use our URL
                      shortening service.
                    </AlertDescription>
                  </Alert>
                  <form action={dispatchGoogle}>
